...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="w-full bg-white border-b border-gray-100 px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link to="/" className="text-gray-600 hover:text-blue-600 text-sm font-medium transition">Home</Link>
            <a href="#why-choose-us" className="text-gray-600 hover:text-blue-600 text-sm font-medium transition">Services</a>
            <a href="#footer" className="text-gray-600 hover:text-blue-600 text-sm font-medium transition">About</a>
          </div>
          ...
          <div className="hidden md:flex items-center gap-3">
            {!isLoggedIn ? (
              ...
              <div className="flex items-center gap-4">
                ...
                <button
                  onClick={() => { UserService.logout(); navigate("/"); }}
        ...
        {menuOpen && (
          <div className="md:hidden mt-4 pb-4 flex flex-col gap-4 border-t border-gray-100 pt-4 px-2">
            <Link to="/" className="text-gray-600 text-sm font-medium" onClick={() => setMenuOpen(false)}>Home</Link>
            <a href="#why-choose-us" className="text-gray-600 text-sm font-medium" onClick={() => setMenuOpen(false)}>Services</a>
            <a href="#footer" className="text-gray-600 text-sm font-medium" onClick={() => setMenuOpen(false)}>About</a>
            {!isLoggedIn ? (
              <button
              ...
              <div className="flex flex-col gap-2">
                <span className="text-sm text-gray-600">Hi, {user?.name?.split(" ")[0]}</span>
                <button
                  onClick={() => { UserService.logout(); navigate("/"); setMenuOpen(false); }}
      ...
      {/* Footer */}
      <footer id="footer" className="bg-white border-t border-gray-100 pt-14 pb-8">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 mb-10">
            <div>
              <span className="text-blue-600 font-bold text-lg">🐾 PetConnect</span>
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                {["Find a Pet", "Shelter Login", "Volunteer", "Resources"].map((l) => (
                  <li key={l}><a href="#" className="text-gray-500 text-sm hover:text-blue-600 transition">{l}</a></li>
                ))}
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mb-4">Stay updated with pet care tips and success stories.</p>
          ...
          <div className="border-t border-gray-100 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            <span className="text-gray-400 text-xs">© 2024 PetConnect Inc. All rights reserved.</span>
            <div className="flex gap-4 flex-wrap justify-center">
              {["Privacy Policy", "Terms of Service", "Cookie Settings"].map((l) => (
                <a key={l} href="#" className="text-gray-400 text-xs hover:text-gray-600 transition">{l}</a>
              ))}
            </div>
          </div>
        </div>
