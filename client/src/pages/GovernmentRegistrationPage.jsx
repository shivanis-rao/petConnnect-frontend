      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-4 py-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 mb-4">
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            ...
            <div>
              <label className="block text-xs text-gray-500 mb-1">
                State / Municipality <span className="text-red-400">*</span>
              </label>
              <input
                type="text"
                ...
                onChange={(e) => {
                  setStateMunicipality(e.target.value);
                  setErrors((p) => ({ ...p, stateMunicipality: "" }));
                }}
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  setGovernmentShelterId(e.target.value);
                  setErrors((p) => ({ ...p, governmentShelterId: "" }));
                }}
          ...
          <div>
            ...
            <div
              className={`border-2 border-dashed rounded-xl p-8 flex flex-col items-center justify-center bg-gray-50 transition-colors ${
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-xs text-gray-500 mb-1">
                Official Contact Email <span className="text-red-400">*</span>
              </label>
              <div
                className={`flex items-center border rounded-lg px-3 py-2 gap-2 ${errors.email ? "border-red-400 bg-red-50" : "border-gray-200"}`}
              >
            ...
            <div>
              <label className="block text-xs text-gray-500 mb-1">
                Official Phone Number <span className="text-red-400">*</span>
              </label>
              <div
                className={`flex items-center border rounded-lg px-3 py-2 gap-2 ${errors.phone ? "border-red-400 bg-red-50" : "border-gray-200"}`}
              >
                <span className="text-gray-400 text-xs">📱</span>
                <input
                  type="tel"
