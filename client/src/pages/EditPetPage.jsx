...
import { Save, Heart, List, MessageSquare, BarChart2, LogOut, Plus, PawPrint } from 'lucide-react'
...
export default function EditPetPage() {
  ...
  const [form, setForm] = useState({
    ...
    status: 'Available', vaccinated: '', special_needs: '',
    good_with_kids: '', sterilized: 'not_sterilized',
    ...
    const fetchPet = async () => {
      try {
        ...
        setForm({
          ...
          special_needs: pet.special_needs !== null ? String(pet.special_needs) : '',
          good_with_kids: pet.good_with_kids !== null ? String(pet.good_with_kids) : '',
    ...
    <div className="flex min-h-screen bg-[#f5f7fa]">
      ...
      <div className="flex-1 p-6 overflow-y-auto">
        <div className="max-w-4xl">
          ...
          {/* Header */}
          <div className="mb-6">
            <h1 className="text-xl font-semibold text-[#1B3A4B] mb-1">Edit Pet</h1>
            <p className="text-xs text-gray-600">Update the details for this pet listing.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <section className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <RadioGroup
                  label="Gender" required name="gender"
