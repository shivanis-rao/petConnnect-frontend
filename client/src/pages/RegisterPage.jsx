  ...
  <div className="min-h-screen bg-gray-50">
    <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col md:flex-row gap-8 items-start">
      ...
      <div className="flex-1 w-full bg-white rounded-2xl shadow-sm p-6 md:p-10">
        ...
        {success && (
          <div className="bg-green-50 border border-green-200 text-green-600 text-sm px-4 py-3 rounded-lg mb-5">{success}</div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <div className="flex-1 flex items-center border border-gray-200 rounded-lg px-4 py-2.5 gap-2 focus-within:ring-2 focus-within:ring-cyan-400">
                ...
                />
                {otpVerified && <span className="text-green-500 text-xs font-semibold whitespace-nowrap">✓ Verified</span>}
              </div>
          ...
          {otpSent && !otpVerified && (
            <div>
              <label className="block text-xs font-semibold text-gray-600 uppercase tracking-wide mb-1.5">Enter OTP</label>
              <div className="flex gap-2">
              ...
              <button type="button" onClick={handleSendOtp} className="text-xs text-cyan-500 hover:underline mt-1.5">
                Resend OTP
              </button>
            </div>
          )}
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <Link to="/login" className="text-cyan-500 font-semibold hover:underline">Log in</Link>
        </p>
      </div>
    </div>
  </div>
