...
const PetService = {
  browsePets: async (filters = {}) => {
    ...
    if (filters.vaccinated !== undefined) params.append('vaccinated', filters.vaccinated);
    if (filters.special_needs !== undefined) params.append('special_needs', filters.special_needs);
    if (filters.good_with_kids !== undefined) params.append('good_with_kids', filters.good_with_kids);
